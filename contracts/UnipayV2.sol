...
contract UniPay{
    ...
    function AddPayee(string memory _name,uint256 _amount,address _addr) public {
            ...
            Payer_details[msg.sender].Payer=msg.sender;
   ...
   function WithdrawPayer(uint256 _amount) payable public  {      
       require(Payer_details[msg.sender].Balance>0 && _amount<=Payer_details[msg.sender].Balance,"Insufficient Funds");
       Payer_details[msg.sender].Balance-=_amount;
